...
\cvitem{-}{Python (\emph{fluent}) - hands-on experience in several machine/deep learning libraries (such as numpy, pandas, scikit-learn, keras}
\cvitem{-}{PyCharm, DataGrip, MATLAB, SPSS}
\cvitem{-}{(Postgre)SQL, \LaTeX, Git}
\cvitem{-}{Tableau, AWS (Redshift, S3, Step Functions), Airflow}

\section{Education}
\cventry{Exp: 04.2022}{PhD}{Mathematical Engineering}{Istanbul Technical University, Turkey}{}{Title: Time series classification via Topological Data Analysis}{}
\cventry{2019}{M.A.}{Psychology}{Boğaziçi University, Turkey}{}{Title: In Search of Tonal Grounds for Short Term Melody Recognition}{}
\cventry{2015}{M.S.}{Mathematics}{Boğaziçi University, Turkey}{}{Title: Topologies on Families of Closed Subsets}{}
